...
*(See "Update — 2026-07-25" above — CSP/Referrer-Policy are now addressed for `f12.biz`; HSTS/X-Frame-Options/X-Content-Type-Options remain a GitHub Pages platform limit.)*
